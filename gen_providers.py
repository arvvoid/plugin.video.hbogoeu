...
for countrie in countries:
    ...
    for operator in json_web_operators['Items']:
        ...
        web_operators = web_operators + "   '" + operator['Name'] + "': ['" + operator['Id'] + "', '" + countrie[1] + "', '" + countrie[2] + "', '" + countrie[3] + "', '" + countrie[4] + "', True, '', 'hbogo.eu'],"+os.linesep
    ...
    for operator in json_operators['Items']:
        ...
        extra_operators = extra_operators + "   '"+countrie[0]+": "+operator['Name']+"': ['"+operator['Id']+"', '"+countrie[1]+"', '"+countrie[2]+"', '"+countrie[3]+"', '"+countrie[4]+"', False, '"+operator['RedirectionUrl']+"', 'hbogo.eu'],"+os.linesep
