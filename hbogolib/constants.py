...
class HbogoConstants(object):
    ...
    eu_redirect_login = {
        ...
        'f0e09ddb-1286-4ade-bb30-99bf1ade7cff': ['https://service.upc.cz/login/pkmslogin.form', 'username', 'password', {"login-form-type": "pwd", "username": None, "password": None}],  # Czech Republic: UPC CZ + Slovakia: UPC CZ
