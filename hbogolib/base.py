...
class hbogo(object):
    op_ids = {
        ...
        'HBO Portugal': ['69d3fbeb-91f2-4ab8-b036-0d03f42885b2', 'pt', 'pt', 'PRT', 'POR', True, '', 'hbogo.eu',
        ...
        'Polonia: HBO GO Vip/Club Poland': ['b7018ed3-1858-4436-8e7f-d92a6d0b9bfc', 'pl', 'pl', 'POL', 'POL', False, '',
                                            'hbogo.eu', ''],
        'Portugal: Vodafone TV': ['4b14477f-c5c6-4f1c-9f7b-d5479311a8e8', 'pt', 'pt', 'PRT', 'POR', False, '',
                                  'hbogo.eu', 'https://hboportugal.com'],
